...
**Caps**: 50 sessions per account (oldest evicted when the 51st arrives). Sessions over 500 KB are skipped with a toast. Documents are stored up to 30 KB (already truncated before the AI call anyway).
