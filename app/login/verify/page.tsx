      ...
      >
        <label className="block">
          ...
          <input
            ...
            className="mt-1 w-full rounded border p-2 text-center text-2xl font-mono tracking-widest focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-200"
            placeholder="000000"
          />
        </label>
